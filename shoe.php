...
<body>
    ...
    <div class="explore-card">
        ...
        <div class="formal-shoe">
            <div class="formal-shoe-img">
                <img src="formal-shoes.png" alt="">
            </div>
            <div class="formal-shoe-toptext">
                <h3>20% off</h3>
            </div>
            <div class="formal-shoe-btmtext">
        ...
        <div class="running-shoe">
            <div class="running-shoe-img">
                <img src="running-shoe.png" alt="">
            </div>
            <div class="running-shoe-toptext">
                <h3>25% off</h3>
            </div>
            <div class="running-shoe-btmtext">
                <span>Grab The Latest</span>
    ...
    <div class="gallary">
        <div>
            <span><img src="s1.png" alt="">
                Sneakers</span>
            <span><img src="s2.png" alt=""> Boots</span>
            <span><img src="s3.png" alt="">Formal</span>
            <span><img src="s4.png" alt="">Running</span>
        </div>
        <div>
            <span><img src="s5.png" alt="">Oxford</span>
            <span><img src="s6.png" alt="">Sport Shoe</span>
            <span><img src="s7.png" alt="">High Neck</span>
            <span><img src="s8.png" alt="">Lofers</span>
        </div>
    </div>
    <div class="slide-show">
        <div class="wrapper">
            ...
            <div class="slides">
                <div class="img img-1">
                    <img src="slide1.png" alt="weekend offer">
                </div>
                <div class="text">
                    <p>Weekend Offer</h3>
                    <h1>20% OFF!</h1>
                    <span>Summit Sneakers! Hottest Deals Of The Month</span>
                </div>
            </div>
            ...
            <div class="slides">
                <div class="img img-2">
                    <img src="slide2.png" alt="weekend offer">
                </div>
            ...
            <div class="slides">
                <div class="img img-3">
                    <img src="slide3.png" alt="weekend offer">
                </div>
    ...
    <div class="Best-seller">
        ...
        <div class="cards1">
            <div class="Best-seller-card1">
                <div class="Best-seller-card1-img">
                    <img src="a1.png" alt="Eclipse Sneakers">
                </div>
                <div class="Articles-text">
                    <div class="toptext">
                        <p>Entertainment&nbsp; .&nbsp; April 20, 2025</p>
                    </div>
                    <div class="bottomtext">
                        <h4>Budget Travel: Exploring the World Affordably</h4>
                    </div>
                </div>
            </div>
            <div class="Best-seller-card2">
                ...
                <div class="Articles-text">
                    <div class="toptext">
                        <p>Technology&nbsp; .&nbsp; May 1, 2025</p>
                    </div>
                    <div class="bottomtext">
                        <h4>Improving Sleep Hygiene for Better Rest</h4>
                    </div>
                </div>
            </div>
            <div class="Best-seller-card3">
                <div class="Best-seller-card3-img">
                    <img src="a3.png" alt="Cavora High Neck">
                </div>
                <div class="Articles-text">
                    <div class="toptext">
                        <p>Socical Isuues&nbsp; .&nbsp; June 12, 2025
                        </p>
                    </div>
                    <div class="bottomtext">
                        <h4>Top 10 Rendering Software for Stunning Visuals</h4>
                    </div>
                </div>
            </div>
            <div class="Best-seller-card4">
                <div class="Best-seller-card4-img">
                    <img src="a4.png" alt="Formal Rovik Shoe">
                </div>
                <div class="Articles-text">
                    <div class="toptext">
                        <p>Fashion Guide&nbsp; .&nbsp;July 7, 2025
                        </p>
                    </div>
                    <div class="bottomtext">
                        <h4>10 must-have wardrobe staples every fashion Lover</h4>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="rights">
        ...
        <div class="copyrights">
            <a href="#">Copyright @Snikei. All Rights Reserved
